<? include "../../config/core.php";
	...
	// } else 
	$product_all = db::query("select * from product_raw where company_id = '$company'");
	...
	// else 
	if ($page_result > 0) {
		$product = db::query("select * from product_raw where company_id = '$company' order by name_kz asc limit $page_start, $page_age");
	}
							...
							<? while ($pr_d = mysqli_fetch_assoc($product)): ?>
								...
								<div class="uc_ui uc_ui2">
									<div class="uc_uil">
										...
										<div class="uc_uin_other"><?=$pr_d['name_ru']?></div>
